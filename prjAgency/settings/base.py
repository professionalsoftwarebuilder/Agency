"""
Django settings for prjAgency project.
...
WSGI_APPLICATION = "prjAgency.wsgi.application"
...
STATICFILES_DIRS = [
    os.path.join(PROJECT_DIR, "static_code"),
]
